            ...
            <div class="col-xl-3">
                <div class="card sticky-top" style="top:30px">
                    <div class="list-group list-group-flush" id="useradd-sidenav">
                        <a href="#useradd-1" class="list-group-item list-group-item-action border-0"><?php echo e(__('Personal Information')); ?> <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                        <a href="#useradd-2" class="list-group-item list-group-item-action border-0"><?php echo e(__('Change Password')); ?> <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                        <?php if(\Auth::user()->type=='client'): ?>
                        <a href="#useradd-3" class="list-group-item list-group-item-action border-0"><?php echo e(__('Company Info')); ?> <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        <!-- <div class="choose-files "> -->
                                            <div class="choose-files">
                                                <label for="file-1">
                                                    <div class=" bg-primary company_logo_update"> <i class="ti ti-upload px-1"></i><?php echo e(__('Choose file here')); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <?php if(\Auth::user()->type=='client'): ?>
                    <div class="useradd-3">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0"><?php echo e(__('Company Info')); ?></h5>
                                <small> <?php echo e(__('Details about your company information')); ?></small>
                            </div>
                            <div class="ard-body">
                                <?php echo e(Form::model($userDetail,array('route' => array('client.update.company',$userDetail->id), 'method' => 'post'))); ?>

                            <div class="row">
                                <?php $client=$userDetail->clientDetail; ?>

                                <div class="col-md-4">
                                    <?php echo e(Form::label('company_name',__('Company Name'),['class'=>'col-form-label text-dark'])); ?>

                                    <?php echo e(Form::text('company_name',$client->company_name,array('class'=>'form-control'))); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4">
                                    <?php echo e(Form::label('website',__('Website'),['class'=>'col-form-label text-dark'])); ?>

                                    <?php echo e(Form::text('website',$client->website,array('class'=>'form-control'))); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4">
                                    <?php echo e(Form::label('tax_number',__('Tax Number'),['class'=>'col-form-label text-dark'])); ?>

                                    <?php echo e(Form::text('tax_number',$client->tax_number,array('class'=>'form-control'))); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-12 mb-4">
                                    <?php echo e(Form::label('notes',__('Notes'),['class'=>'col-form-label text-dark'])); ?>

                                    <?php echo e(Form::textarea('notes', $client->notes, ['class'=>'form-control','rows'=>'3'])); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\crmgo\resources\views/user/profile.blade.php ENDPATH**/ ?>