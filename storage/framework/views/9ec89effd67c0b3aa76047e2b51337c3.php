    ...
    <?php if($settings['menubar_status'] == 'on'): ?>
        <div class="container">
            <nav class="navbar navbar-expand-md  default top-nav-collapse">
                <?php if(Storage::exists('/uploads/landing_page_image/' . $settings['site_logo'])): ?>
                            ...
                            <?php $__currentLoopData = json_decode($settings['feature_of_features'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-lg-4 col-sm-6 d-flex">
                                    <div class="card <?php echo e($key == 0 ? 'bg-primary' : ''); ?>">
                                        <div class="card-body">
                                            <?php if(Storage::exists('/uploads/landing_page_image/' . $value['feature_logo'])): ?>
                        ...
                        <div class="col-xxl-3 col-sm-6 col-lg-4 ">
                            <div class="card   border <?php echo e($key == 1 ? 'bg-primary' : 'bg-transparent'); ?>">
                                <div class="card-body text-center">
                                    <?php if(Storage::exists('/uploads/landing_page_image/' . $value['discover_logo'])): ?>
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div
                            ...
                            <div class="card-body">
                                ...
                                <span
                                    class="mb-4 f-w-600 p-price"><?php echo e(\App\Models\Utility::getValByName('currency_symbol') . $value->price); ?><small
                                ...
                                <div class="d-grid">
                                    <a href="<?php echo e(route('register')); ?>"
                                        class="btn btn-primary rounded-pill"><?php echo e(__('Start with
                                                                                Starter')); ?>
...
<?php /**PATH C:\xampp\htdocs\github\company-dowhf-website\Modules/LandingPage\Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>