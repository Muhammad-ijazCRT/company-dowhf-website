...
<?php $__env->startSection('MainContent'); ?>
    <section class="service-section d-flex">
        ...
        <div class="content">
            ...
            <p class="introductory-text">ZAPTA Technologies is a custom software design and development company offering a
                        ...
                        <div class="testi-content d-flex align-items-center ">
                            <div class="teti-text">
                                <p class="zapta-team-p" style="text-align: justify">
                                    “ZAPTA's meticulous attention to detail and unwavering commitment to deadlines fueled a
                                    ...
                                    true partner, not just a vendor. Bravo, ZAPTA!”
                                </p>
...
<?php echo $__env->make('frontend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\crmgo\resources\views/frontend/services.blade.php ENDPATH**/ ?>