...
<section class="getInTouch-sec">
    ...
    <div class="container">
        <div class="contect-detail">
            ...
            <form action="<?php echo e(route('custom.contact.add')); ?>" method="POST" class="get-in-touch">
                <?php echo csrf_field(); ?>
    ...
    <div class="container">
        <div class="footer-cards">
            <div class="footer-card">
                <a href="<?php echo e(route('custom.index')); ?>" aria-label="NavigationToHome"><img
                        src="<?php echo e(asset('cuf_images/bglogo-footer.png')); ?>"
                        loading="lazy" width="150" height="46" alt="fotter logo" /></a>
                <p class="footer-content">
                    <?php echo e(app('companyName')); ?> is a leading software design and development
            ...
            <div class="footer-card">
                ...
                <span data-href-value="<?php echo e(route('custom.about')); ?>" class="footer-link span-link">About Us</span>
                <span data-href-value="<?php echo e(route('custom.services')); ?>" class="footer-link span-link">Services</span>
                <span data-href-value="<?php echo e(route('custom.projects')); ?>" class="footer-link span-link">Projects</span>
                <span data-href-value="<?php echo e(route('custom.blogs')); ?>" class="footer-link span-link">Blogs</span>
                <span data-href-value="#" class="footer-link span-link">Careers</span>
                <span data-href-value="<?php echo e(route('custom.contact')); ?>" class="footer-link span-link">Contact
                    Us</span>
            </div>
        ...
        <p class="copy-rights">
            © 2023 Copyrights <?php echo e(app('companyName')); ?>. All rights are reserved.
        </p>
    </div>
</footer>
...
<!-- custom Base Ajax Script -->
<script src="<?php echo e(asset('custom_frontend/frontend-assets/js/baseAjax.js')); ?>" defer></script>
...
<script src="<?php echo e(asset('custom_frontend/frontend-assets/js/lottie-player2.0.2.min.js')); ?>"></script>

<!-- Jquery -->
<script src="<?php echo e(asset('custom_frontend/frontend-assets/libraries/js/jquery.js')); ?>"></script>
<!--Jquery Ends -->

<!-- Popper Js -->
<script src="<?php echo e(asset('custom_frontend/frontend-assets/libraries/js/popper.js')); ?>" defer=""></script>
<!-- Popper Js Ends -->

<!-- Bootstrap 5 JS -->
<script src="<?php echo e(asset('custom_frontend/frontend-assets/libraries/js/bootstrap.js')); ?>" defer=""></script>
<!-- Bootstrap 5 JS Ends-->


<!-- Jquery-validation JS -->
<script src="<?php echo e(asset('custom_frontend/frontend-assets/libraries/js/jqueryValidate.js')); ?>"></script>
<!-- Jquery-validation cdn Ends-->

<script src="<?php echo e(asset('custom_frontend/frontend-assets/js/feedackSelector.js')); ?>" defer=""></script>



<!-- JS -->
<script src="<?php echo e(asset('custom_frontend/frontend-assets/libraries/js/particles.js')); ?>" defer=""></script>
<!-- JS Ends -->

<script src="<?php echo e(asset('custom_frontend/frontend-assets/js/main.js')); ?>" defer=""></script>
...
<!-- custom Js -->
<script src="<?php echo e(asset('custom_frontend/frontend-assets/js/script.js')); ?>" data-param1="[]" data-param2="[&quot;&quot;]"
    defer></script>
<!-- custom Js Ends -->

<script src="<?php echo e(asset('custom_frontend/frontend-assets/js/main.js')); ?>" defer></script>

<script cache-files="cached" src="<?php echo e(asset('custom_frontend/frontend-assets/libraries/js/select2.js')); ?>"></script>

<script src="<?php echo e(asset('custom_frontend/frontend-assets/js/customSwipper.js')); ?>" defer=""></script>
...
<script>
    ...
    var baseUrl = "<?php echo e(route('custom.index')); ?>";
</script>
...
<script type="application/ld+json">
    {
      ...
      "@type": "Organization",
      "name": "<?php echo e(app('companyName')); ?>",
...
<?php /**PATH C:\xampp\htdocs\crmgo\resources\views/frontend/layout/footer.blade.php ENDPATH**/ ?>