                ...
                <div class="col-4">
                    ...
                    <a href="#" class="project-card">
                        <div class="project-thumbnail">
                            ...
                            <img class="thumbnail-img" src="<?php echo e(asset('')); ?>" alt="Sohcahtoa Mockup Single"
                                style="display: none;">
                        </div>
                        ...
                        <div class="project-description">
                            ...
                            <p class="project-intro"><?php echo e($project->description); ?></p>
                        </div>
                        ...
                        <div class="d-flex pt-2">
                            <?php if($project->status == 'not_started'): ?>
                                <button class="btn bt-large bg-primary p-2 px-3 rounded"><?php echo e(__('Not Started')); ?></button>
                            <?php elseif($project->status == 'in_progress'): ?>
                                <button class="btn bt-large bg-success p-2 px-3 rounded"><?php echo e(__('In Progress')); ?></button>
                            <?php elseif($project->status == 'on_hold'): ?>
                                <button class="btn bt-large bg-info p-2 px-3 rounded"><?php echo e(__('On Hold')); ?></button>
                            <?php elseif($project->status == 'canceled'): ?>
                                <button class="btn bt-large bg-danger p-2 px-3 rounded"><?php echo e(__('Canceled')); ?></button>
                            <?php elseif($project->status == 'finished'): ?>
                                <button class="btn bt-large bg-warning p-2 px-3 rounded"><?php echo e(__('Finished')); ?></button>
                            <?php endif; ?>
                            <a href="#" class="btn bt-large bg-info p-2 px-3 rounded"><?php echo e(__('Readmore')); ?></a>
                        </div>
                    </a>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="card hover-shadow-lg">
                        ...
                        <div class="card-body text-center">
                            <h5 class="my-4">
                                <span class="text-dark"><?php echo e($project->title); ?></span>
                            </h5>
...
<?php echo $__env->make('frontend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\crmgo\resources\views/frontend/projects.blade.php ENDPATH**/ ?>